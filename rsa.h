...
string RSA::ciphermetin(string f){
	...
	for (i = 0; i < f.length(); i++){
		...
		{	dizi[0] = y[i] - 87;
		ddizi[i] = (double)dizi[0];

		break;
		}
		case 'b':
		{	dizi[1] = y[i] - 87;
		ddizi[i] = (double)dizi[1];

		break;
		}
		case 'c':
		{	dizi[2] = y[i] - 87;
		ddizi[i] = (double)dizi[2];
		...
		case 'd':
		{	dizi[3] = y[i] - 87;
		ddizi[i] = (double)dizi[3];

		break;
		}
		case 'e':
		{	dizi[4] = y[i] - 87;
		ddizi[i] = (double)dizi[4];

		break;
		}
		case 'f':
		{	dizi[5] = y[i] - 87;
		ddizi[i] = (double)dizi[5];

		break;
		}
		case 'g':
		{	dizi[6] = y[i] - 87;
		ddizi[i] = (double)dizi[6];

		break;
		}
		case 'h':
		{	dizi[7] = y[i] - 87;
		ddizi[i] = (double)dizi[7];
		break;
		}
		case 'i':
		{	dizi[8] = y[i] - 87;
		ddizi[i] = (double)dizi[8];

		break;
		}
		case 'j':   //10
		{	dizi[9] = y[i] - 87;
		ddizi[i] = (double)dizi[9];

		break;
		}
		case 'k':
		{	dizi[10] = y[i] - 87;
		ddizi[i] = (double)dizi[10];

		break;
		}
		case 'l':
		{	dizi[11] = y[i] - 87;
		ddizi[i] = (double)dizi[11];

		break;
		}
		case 'm':
		{	dizi[12] = y[i] - 87;
		ddizi[i] = (double)dizi[12];

		break;
		}
		case 'n':
		{	dizi[13] = y[i] - 87;
		ddizi[i] = (double)dizi[13];

		break;
		}
		case 'o':
		{	dizi[14] = y[i] - 87;
		ddizi[14] = (double)dizi[14];

		break;
		}
		case 'p':
		{	dizi[15] = y[i] - 87;
		ddizi[i] = (double)dizi[15];

		break;
		}
		case 'q':
		{	dizi[16] = y[i] - 87;
		ddizi[i] = (double)dizi[16];

		break;
		}
		case 'r':
		{	dizi[17] = y[i] - 87;
		ddizi[i] = (double)dizi[17];

		break;
		}
		case 's':
		{	dizi[18] = y[i] - 87;
		ddizi[i] = (double)dizi[18];

		break;
		}
		case 't': //20
		{	dizi[19] = y[i] - 87;
		ddizi[i] = (double)dizi[19];

		break;
		}
		case 'u':
		{	dizi[20] = y[i] - 87;
		ddizi[i] = (double)dizi[20];

		break;
		}
		case 'v':
		{	dizi[21] = y[i] - 87;
		ddizi[i] = (double)dizi[21];

		break;
		}
		case 'w':
		{	dizi[22] = y[i] - 87;
		ddizi[i] = (double)dizi[22];

		break;
		}
		case 'x':
		{	dizi[23] = y[i] - 87;
		ddizi[i] = (double)dizi[23];

		break;
		}
		case 'y':
		{	dizi[24] = y[i] - 87;
		ddizi[i] = (double)dizi[24];

		break;
		}
		case 'z':
		{	dizi[25] = y[i] - 87;
		ddizi[i] = (double)dizi[25];
